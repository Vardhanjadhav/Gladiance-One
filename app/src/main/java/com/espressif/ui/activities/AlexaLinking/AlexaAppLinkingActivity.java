package com.espressif.ui.activities.AlexaLinking;
...
public class AlexaAppLinkingActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (!TextUtils.isEmpty(alexaRefreshToken)) {
            ...
            apiManager.getNewToken(new com.espressif.cloudapi.ApiResponseListener() {
        ...
        if (intent.getData() != null) {
            ...
            if (data.contains(AppConstants.STATE)) {
                ...
                if (appLinkingProgress.equals(AppLinkingProgress.GET_ALEXA_CODE)) {
                    ...
                    apiManager.getAlexaAccessToken(BuildConfig.ALEXA_REDIRECT_URL, alexaCode, new com.espressif.cloudapi.ApiResponseListener() {
