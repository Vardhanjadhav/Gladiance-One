...
public class ProvisionLanding extends ManualProvBaseActivity {
    ...
    private String deviceName, pop, mac;
...
//        mac = getIntent().getStringExtra(AppConstants.MAC);
        initViews();
    }
    ...
    private void goToWifiScanListActivity() {
       ...
       // wifiListIntent.putExtra(AppConstants.MAC, espDevice.getMac());
//        wifiListIntent.putExtra("keyStringData", AppConstants.MAC);
//        Log.d(TAG, "goToWifiScanListActivity: " +AppConstants.MAC);
