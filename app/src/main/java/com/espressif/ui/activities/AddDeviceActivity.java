...
//            Log.d(TAG, "onResume: " +AppConstants.MAC);
...
//        cameraPreview = findViewById(R.id.preview);
    ...
    private void openCamera() {
        ...
        scanQrCode();
//        ESPProvisionManager myJavaClass = new ESPProvisionManager(this);

// Store a string
//        myJavaClass.saveString("myStringKey", "Hello, World!");

// Retrieve the string
//        String Mac = myJavaClass.getString("myStringKey", "Default Value if Key not found");
//        AppConstants.MAC = Mac;
//        Log.d(TAG, "MAC App Constant: " +AppConstants.MAC);
//        fetchData();
    }
    ...
    private void handleApiResponse(ResponseModelNode data) {
        ...
        if (data != null) {
            ...
            Log.d(TAG, "handleApiResponse nodeId: " +data.getNodeId());
    ...
    private void goToWiFiScanActivity() {
        ...
        intent.putExtra("keyStringData", node_id);
...
//            wifiProvisioningIntent.putExtra(AppConstants.MAC, espDevice.getMac());
//            Log.d(TAG, "Mac goToWiFiProvisionLandingActivity: " +AppConstants.MAC);
