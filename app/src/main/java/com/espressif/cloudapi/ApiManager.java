...
public class ApiManager {
    ...
    public static ApiManager getInstance(Context context, EspApplication eApp) {

        if (apiManager == null) {
            apiManager = new ApiManager(context, eApp);
        }
        return apiManager;
    }

    public ApiManager(Context context, EspApplication eApp) {
    ...
    public void login(final String userName, String password, final com.espressif.cloudapi.ApiResponseListener listener) {
...
//    public void getOAuthToken(String code, final com.espressif.cloudapi.ApiResponseListener listener) {
//
...
//    public void createUser(String email, String password, final com.espressif.cloudapi.ApiResponseListener listener) {
//
...
//    public void confirmUser(String email, String verificationCode, final com.espressif.cloudapi.ApiResponseListener listener) {
//
...
//    public void deleteUserRequest(boolean request, final com.espressif.cloudapi.ApiResponseListener listener) {
//
...
//    public void deleteUserConfirm(String verificationCode, final com.espressif.cloudapi.ApiResponseListener listener) {
//
...
//    public void forgotPassword(String email, final com.espressif.cloudapi.ApiResponseListener listener) {
//
...
//    public void resetPassword(String email, String newPassword, String verificationCode, final com.espressif.cloudapi.ApiResponseListener listener) {
//
...
//    public void changePassword(String oldPassword, String newPassword, final com.espressif.cloudapi.ApiResponseListener listener) {
//
...
//    public void logout(final com.espressif.cloudapi.ApiResponseListener listener) {
//
//        Log.d(TAG, "Logout...");
...
//    }
     ...
     */
//    public void getSupportedVersions(final com.espressif.cloudapi.ApiResponseListener listener) {
//
...
//    }
     ...
     * @param listener Listener to send success or failure.
     */
    public void getNodes(String nodeId, final com.espressif.cloudapi.ApiResponseListener listener) {
        ...
        espApp.nodeMap.put(nodeId, new EspNode(nodeId));
...
//        getNodesFromCloud("", listener);
    ...
    private void getNodesFromCloud(final String startId, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void getNodeDetails(String nodeId, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void getNodeStatus(final String nodeId, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void addNode(final String nodeId, String secretKey,
                        final com.espressif.cloudapi.ApiResponseListener listener) {
     ...
     * @param listener Listener to send success or failure.
     */
    public void removeNode(final String nodeId, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void getParamsValues(final String nodeId, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void updateParamValue(final String nodeId, JsonObject body, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void initiateClaim(JsonObject body, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void verifyClaiming(JsonObject body, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void createGroup(JsonObject body, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void updateGroup(final String groupId, JsonObject body, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void removeGroup(final String groupId, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void getUserGroups(final String groupId, final com.espressif.cloudapi.ApiResponseListener listener) {

        Log.d(TAG, "Get user groups...");
        getUserGroupsFromCloud("", groupId, listener);
    }

    private void getUserGroupsFromCloud(final String startId, final String groupId, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void getSharingRequests(boolean isPrimaryUser, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    private void getSharingRequests(final String startReqId, final String startUserName, final boolean isPrimaryUser,
                                    final ArrayList<SharingRequest> sharingRequests, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void updateSharingRequest(final String requestId, final boolean requestAccepted, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void removeSharingRequest(final String requestId, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void shareNodeWithUser(final String nodeId, final String email, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void getNodeSharing(final String nodeId, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void removeSharing(final String nodeId, final String email, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void registerDeviceToken(final String deviceToken, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void unregisterDeviceToken(final String deviceToken, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void getTimeSeriesData(String nodeId, String paramName, String dataType,
                                  ...
                                  long endTime, String weekStart, String timezone, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    private void getTimeSeriesDataForOnePage(String nodeId, String paramName, String dataType,
                                             ...
                                             String startId, final com.espressif.cloudapi.ApiResponseListener listener,
    ...
    public void addAutomations(JsonObject body, final com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void getAutomations(com.espressif.cloudapi.ApiResponseListener listener) {
        Log.d(TAG, "Get Automations");
        automationIds.clear();
        getAutomations("", listener);
    }

    private void getAutomations(String startId, com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void updateAutomation(Automation automation, JsonObject body, com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void deleteAutomation(String automationId, com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void checkFwUpdate(String nodeId, com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void getFwUpdateStatus(String nodeId, String otaJobId, com.espressif.cloudapi.ApiResponseListener listener) {
    ...
    public void pushFwUpdate(String nodeId, String otaJobId, com.espressif.cloudapi.ApiResponseListener listener) {
...
//    private static final String TAG = com.espressif.ui.activities.ApiManager.class.getSimpleName();
//    private ApiInterface apiInterface;
//    private static String accessToken = "";
//
//    private EspApplication espApp;
...
//
//
//    public void getNodeDetails(String nodeId, final com.espressif.ui.activities.ApiResponseListener listener) {
//
//        Log.d(TAG, "Get Node Details for id : " + nodeId);
//
//        apiInterface.getNode(AppConstants.URL_USER_NODES, accessToken, nodeId).enqueue(new Callback<ResponseBody>() {
